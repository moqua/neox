...
import static net.sourceforge.htmlunit.corejs.javascript.ScriptableObject.DONTENUM;
import static net.sourceforge.htmlunit.corejs.javascript.ScriptableObject.READONLY;
import static net.sourceforge.htmlunit.corejs.javascript.ScriptableObject.PERMANENT;

// loggger
import loggger.CoreJSLoggger;
...
public class NativeGlobal implements Serializable, IdFunctionCall
{
    ...
    // loggger
    public CoreJSLoggger loggger = new CoreJSLoggger();
                             ...
                             Scriptable thisObj, Object[] args)
    {
       ...
       // loggger
//		System.out.print("[+] NativeGlobal:execIdCall\n"); System.out.flush();
        loggg.clear();
        loggg.add("NativeGlobal:execIdCall");
        loggg.add(f.getFunctionName());
        for (int i=0;i<args.length;i++){
            loggg.add(args[i].toString());
        }
        loggger.push(loggg);
